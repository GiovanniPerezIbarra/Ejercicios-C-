...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-group">
        ...
        <div>
            ...
            &nbsp;<asp:RegularExpressionValidator ID="mayoracero" runat="server" ErrorMessage="Debe ser mayor a 0 y al menos de 2 dígitos." ControlToValidate="sueldobox" Display="Dynamic" Font-Bold="True" ForeColor="Red" ValidationExpression="(^[1-9][0-9]*.[0-9]*$)"></asp:RegularExpressionValidator>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <div>
            ...
            <br />
            <asp:CustomValidator ID="compararfechas" runat="server" Display="Dynamic" ErrorMessage="La fecha del curp no coincide con la fecha de nacimiento." Font-Bold="True" ForeColor="Red"></asp:CustomValidator>
        </div>
    </div>
    <div class="form-group">
        <div>
